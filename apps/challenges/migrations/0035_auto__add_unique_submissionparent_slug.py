...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'SubmissionParent', fields ['slug']
        db.create_unique('challenges_submissionparent', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SubmissionParent', fields ['slug']
        db.delete_unique('challenges_submissionparent', ['slug'])
    ...
    models = {
        ...
        'challenges.phase': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 12, 49, 35, 795204)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
