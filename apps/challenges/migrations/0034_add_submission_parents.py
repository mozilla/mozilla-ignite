...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Creates ``SubmisionParents`` to the ``Submissions``"
        for submission in orm.Submission.objects.all():
            ...
            orm.SubmissionParent.objects.get_or_create(**data)

    def backwards(self, orm):
        """Removing any ``SubmissionParent``"""
        orm.SubmissionParent.objects.all().delete()
    ...
    models = {
        ...
        'challenges.phase': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 12, 4, 37, 85795)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
