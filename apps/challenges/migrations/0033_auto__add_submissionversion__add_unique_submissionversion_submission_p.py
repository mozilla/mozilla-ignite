...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SubmissionVersion'
        db.create_table('challenges_submissionversion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('submission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.Submission'])),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.SubmissionParent'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
        ))
        db.send_create_signal('challenges', ['SubmissionVersion'])

        # Adding unique constraint on 'SubmissionVersion', fields ['submission', 'parent']
        db.create_unique('challenges_submissionversion', ['submission_id', 'parent_id'])

        # Adding model 'SubmissionParent'
        db.create_table('challenges_submissionparent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('challenges', ['SubmissionParent'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SubmissionVersion', fields ['submission', 'parent']
        db.delete_unique('challenges_submissionversion', ['submission_id', 'parent_id'])

        # Deleting model 'SubmissionVersion'
        db.delete_table('challenges_submissionversion')

        # Deleting model 'SubmissionParent'
        db.delete_table('challenges_submissionparent')
    ...
    models = {
        ...
        'challenges.phase': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 11, 26, 1, 506708)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'challenges.submissionparent': {
            'Meta': {'object_name': 'SubmissionParent'},
