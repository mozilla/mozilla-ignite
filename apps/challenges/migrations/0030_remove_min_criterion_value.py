...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'JudgingCriterion.min_value'
        db.delete_column('challenges_judgingcriterion', 'min_value')


    def backwards(self, orm):
        
        # Adding field 'JudgingCriterion.min_value'
        db.add_column('challenges_judgingcriterion', 'min_value', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    ...
    models = {
        ...
        'challenges.phase': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 23, 12, 32, 39, 203646)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
