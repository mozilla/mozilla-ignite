...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ExternalLink.profile'
        db.delete_column('challenges_externallink', 'profile_id')

        # Adding field 'ExternalLink.submission'
        db.add_column('challenges_externallink', 'submission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.Submission'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ExternalLink.profile'
        db.add_column('challenges_externallink', 'profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'], null=True, blank=True), keep_default=False)

        # Deleting field 'ExternalLink.submission'
        db.delete_column('challenges_externallink', 'submission_id')
