...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Submission.description_html'
        db.delete_column('challenges_submission', 'description_html')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Submission.description_html'
        db.add_column('challenges_submission', 'description_html', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
