...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.sketh_note'
        db.add_column('challenges_submission', 'sketh_note', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.sketh_note'
        db.delete_column('challenges_submission', 'sketh_note')
