...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('challenges_submission', 'updated_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True), keep_default=False)

        # Adding field 'Submission.phase_round'
        db.add_column('challenges_submission', 'phase_round', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.PhaseRound'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.updated_on'
        db.delete_column('challenges_submission', 'updated_on')

        # Deleting field 'Submission.phase_round'
        db.delete_column('challenges_submission', 'phase_round_id')
    ...
    models = {
        ...
        'challenges.phase': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 8, 12, 31, 40, 691150)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
