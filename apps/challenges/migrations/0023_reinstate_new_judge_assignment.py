...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'JudgeAssignment', fields ['submission', 'judge']
        db.create_unique('challenges_judgeassignment', ['submission_id', 'judge_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'JudgeAssignment', fields ['submission', 'judge']
        db.delete_unique('challenges_judgeassignment', ['submission_id', 'judge_id'])
    ...
    models = {
        ...
        'challenges.phase': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 31, 17, 25, 15, 623918)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
