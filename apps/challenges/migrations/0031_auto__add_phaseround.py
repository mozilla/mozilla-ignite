...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('challenges_phaseround', (
        ...
        db.send_create_signal('challenges', ['PhaseRound'])


    def backwards(self, orm):
        
        # Deleting model 'PhaseRound'
        db.delete_table('challenges_phaseround')
    ...
    models = {
        ...
        'challenges.phase': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 7, 15, 42, 49, 766041)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
