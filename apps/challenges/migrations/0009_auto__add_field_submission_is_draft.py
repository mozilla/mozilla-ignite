...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.is_draft'
        db.add_column('challenges_submission', 'is_draft', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.is_draft'
        db.delete_column('challenges_submission', 'is_draft')
