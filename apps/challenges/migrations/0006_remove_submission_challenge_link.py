...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        if not db.dry_run:
            if orm.Submission.objects.filter(phase=None).exists():
                raise RuntimeError("Cannot run this migration. Submissions "
                                   "exist with no associated phase.")

        # Changing field 'Submission.phase'
        db.alter_column('challenges_submission', 'phase_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['challenges.Phase']))

        # Deleting field 'Submission.challenge'
        db.delete_column('challenges_submission', 'challenge_id')



    def backwards(self, orm):
        
        # Adding field 'Submission.challenge'
        db.add_column('challenges_submission', 'challenge', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.Challenge'], null=True, blank=True), keep_default=False)

        # Changing field 'Submission.phase'
        db.alter_column('challenges_submission', 'phase_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.Phase'], null=True))
