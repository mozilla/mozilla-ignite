...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        """We don't move the votes backwards"""
        pass
    ...
    models = {
        ...
        'challenges.phase': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 4, 11, 46, 6, 270716)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
    ...
    complete_apps = ['voting', 'challenges']
