...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SubmissionHelp'
        db.create_table('challenges_submissionhelp', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['challenges.SubmissionParent'], unique=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')()),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('challenges', ['SubmissionHelp'])


    def backwards(self, orm):
        
        # Deleting model 'SubmissionHelp'
        db.delete_table('challenges_submissionhelp')
    ...
    models = {
        ...
        'challenges.phase': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 20, 15, 20, 19, 324207)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'challenges.submissionhelp': {
            'Meta': {'object_name': 'SubmissionHelp'},
