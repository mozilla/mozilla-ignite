...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExclusionFlag'
        db.create_table('challenges_exclusionflag', (
        ...
        db.send_create_signal('challenges', ['ExclusionFlag'])


    def backwards(self, orm):
        
        # Deleting model 'ExclusionFlag'
        db.delete_table('challenges_exclusionflag')
    ...
    models = {
        ...
        'challenges.phase': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 1, 13, 0, 35, 631451)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
