...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.required_effort'
        db.add_column('challenges_submission', 'required_effort', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.required_effort'
        db.delete_column('challenges_submission', 'required_effort')
    ...
    models = {
        ...
        'challenges.phase': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 3, 11, 54, 20, 191841)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'challenges.submission': {
            ...
            'required_effort': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
