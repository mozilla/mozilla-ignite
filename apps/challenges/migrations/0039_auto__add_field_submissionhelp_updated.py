...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionHelp.updated'
        db.add_column('challenges_submissionhelp', 'updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubmissionHelp.updated'
        db.delete_column('challenges_submissionhelp', 'updated')
    ...
    models = {
        ...
        'challenges.phase': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 21, 14, 12, 0, 302993)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'challenges.submissionhelp': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'SubmissionHelp'},
