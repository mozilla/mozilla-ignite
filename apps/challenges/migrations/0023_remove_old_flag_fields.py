...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Submission.flagged_offensive'
        db.delete_column('challenges_submission', 'flagged_offensive')

        # Deleting field 'Submission.flagged_offensive_reason'
        db.delete_column('challenges_submission', 'flagged_offensive_reason')


    def backwards(self, orm):
        
        # Adding field 'Submission.flagged_offensive'
        db.add_column('challenges_submission', 'flagged_offensive', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Submission.flagged_offensive_reason'
        db.add_column('challenges_submission', 'flagged_offensive_reason', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'challenges.judgeassignment': {
            'Meta': {'object_name': 'JudgeAssignment'},
            ...
            'submission': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['challenges.Submission']", 'unique': 'True'})
        },
        ...
        'challenges.phase': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 1, 13, 2, 27, 851497)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
