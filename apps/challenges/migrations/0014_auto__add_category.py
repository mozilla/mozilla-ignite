...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('challenges_category', (
        ...
        db.send_create_signal('challenges', ['Category'])


    def backwards(self, orm):
        
        # Deleting model 'Category'
        db.delete_table('challenges_category')
    ...
    models = {
        ...
        'challenges.submission': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 6, 13, 20, 57, 618590)'}),
            'description': ('django.db.models.fields.TextField', [], {}),
