...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ExclusionFlag.reason'
        db.delete_column('challenges_exclusionflag', 'reason')


    def backwards(self, orm):
        
        # Adding field 'ExclusionFlag.reason'
        db.add_column('challenges_exclusionflag', 'reason', self.gf('django.db.models.fields.CharField')(default='other', max_length=50), keep_default=False)
    ...
    models = {
        ...
        'challenges.phase': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 3, 11, 31, 19, 453265)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
