...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.created_by'
        db.add_column('challenges_submission', 'created_by', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['users.Profile']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Submission.created_by'
        db.delete_column('challenges_submission', 'created_by_id')
