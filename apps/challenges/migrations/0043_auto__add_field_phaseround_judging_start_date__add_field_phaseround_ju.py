...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PhaseRound.judging_start_date'
        db.add_column('challenges_phaseround', 'judging_start_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'PhaseRound.judging_end_date'
        db.add_column('challenges_phaseround', 'judging_end_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Phase.judging_start_date'
        db.add_column('challenges_phase', 'judging_start_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Phase.judging_end_date'
        db.add_column('challenges_phase', 'judging_end_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PhaseRound.judging_start_date'
        db.delete_column('challenges_phaseround', 'judging_start_date')

        # Deleting field 'PhaseRound.judging_end_date'
        db.delete_column('challenges_phaseround', 'judging_end_date')

        # Deleting field 'Phase.judging_start_date'
        db.delete_column('challenges_phase', 'judging_start_date')

        # Deleting field 'Phase.judging_end_date'
        db.delete_column('challenges_phase', 'judging_end_date')
    ...
    models = {
        ...
        'challenges.phase': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 1, 10, 42, 39, 777574)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'judging_end_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'judging_start_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
