...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('challenges_submission', 'created_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 12, 5, 14, 56, 29, 471287)), keep_default=False)
    ...
    models = {
        ...
        'challenges.submission': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 5, 14, 56, 29, 471287)'}),
            'description': ('django.db.models.fields.TextField', [], {}),
